...
@AllArgsConstructor
@Getter
public abstract class AbstractCreateUseCase<Entity extends BaseEntity, Repository extends CreateAndUpdateRepository<Entity>, InputValues extends AbstractUseCase.InputValues>
